...
class FlightProfiler():
    ...
    def preprocessDataResample(self, file, path, spatialResolution, lambda1, lambda2, order, configFile, configPath):
        ...
        flightNumber = self.getFlightConfiguration(file, configFile, configPath)
